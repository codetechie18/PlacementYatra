...
import { Rocket, Mail, Lock, User, ChevronDown, Loader2 } from "lucide-react";

export default function Signup() {
  const { signup, loading } = useRole();
  ...
  const inputClass =
    "w-full h-11 pl-10 pr-4 rounded-xl border border-border bg-background text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring transition-shadow text-sm";
